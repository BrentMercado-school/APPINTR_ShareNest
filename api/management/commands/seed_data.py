    ...
    def handle(self, *args, **kwargs):
        ...
        items = [
            ...
            },
            {
                "category": "Books",
                "owner_name": "Name1",
                "name": "Slamdunk Comics",
                "description": "A comic book for Slamdunk anime",
                "condition": "Very Good",
                "security_deposit": 1000.00,
                "note": "Handle with care",
                "status": "AVAILABLE",
            ...
            },
            {
                ...
                "owner_name": "Name2",
                "name": "Bike Cleats",
                "description": "A shoes for biking",
                "condition": "Good",
                "security_deposit": 500.00,
                "note": "Handle with care",
                "status": "AVAILABLE",
            ...
            },
            {
                "category": "Books",
                "owner_name": "Name2",
                "name": "Avengers Endgame Comics",
                "description": "A comic book for Avengers",
                "condition": "Very Good",
                "security_deposit": 1000.00,
                "note": "Handle with care",
                "status": "AVAILABLE",
